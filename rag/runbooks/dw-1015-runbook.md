kind: runbook
title: DW-1015 response runbook
...
# DW-1015 Spark Executor Memory Exhausted response runbook

Runbook checklist for responding to DW-1015.

## Triage
1. Confirm severity HIGH and affected service spark-cluster.
