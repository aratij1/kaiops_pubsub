kind: runbook
title: DW-1007 response runbook
services: snowflake
...
# DW-1007 Warehouse Storage Usage High response runbook

Runbook checklist for responding to DW-1007.

## Triage
1. Confirm severity HIGH and affected service snowflake.
