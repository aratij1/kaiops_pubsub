kind: runbook
title: DW-1012 response runbook
...
# DW-1012 Dimension Load Failure response runbook

Runbook checklist for responding to DW-1012.

## Triage
1. Confirm severity HIGH and affected service customer-dimension.
