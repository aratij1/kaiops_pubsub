kind: runbook
title: DW-1016 response runbook
...
# DW-1016 Failed CDC Processing response runbook

Runbook checklist for responding to DW-1016.

## Triage
1. Confirm severity CRITICAL and affected service cdc-pipeline.
