...
export const NAVIGATION_ITEMS: readonly NavigationItem[] = [
  ...
  { id: "platformOverview", legacyTab: "admin", path: "/platform", label: "Control Plane", pageTitle: "Platform Control Plane", description: "Live readiness, data flow, AI, context, and governance posture.", group: "platform", routeModule: "platform", icon: "platformOverview", keywords: ["platform", "control plane", "readiness", "health", "governance"], allowedRoles: ADMIN_ROLES, related: ["cloudConnections", "admin", "operationsCockpit"] },
