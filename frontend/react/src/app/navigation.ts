...
export const NAVIGATION_ITEMS: readonly NavigationItem[] = [
  ...
  { id: "incidents", legacyTab: "summary", path: "/incidents", label: "Incidents", pageTitle: "Incidents", description: "Investigate evidence and prepare governed decisions.", group: "operations", routeModule: "incidents", icon: "incidents", keywords: ["case", "investigate", "evidence", "rca"], allowedRoles: ALL_ROLES, related: ["alerts", "approvals"] },
