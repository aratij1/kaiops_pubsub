...
export const NAVIGATION_ITEMS: readonly NavigationItem[] = [
  ...
  { id: "cloudConnections", legacyTab: "admin", path: "/cloud-ops/connections", label: "Connections", pageTitle: "Connections", description: "Connect monitoring and cloud providers, then verify that Kai can read them.", group: "platform", routeModule: "cloud-ops/connections", icon: "cloudConnections", keywords: ["integrations", "connectors", "cloud", "providers"], allowedRoles: ADMIN_ROLES, related: ["cloudResources", "services"] },
