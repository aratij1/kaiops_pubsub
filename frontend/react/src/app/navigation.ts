...
export const NAVIGATION_ITEMS: readonly NavigationItem[] = [
  { id: "dashboard", legacyTab: "home", path: "/", label: "Command Center", pageTitle: "Command Center", group: "operations", routeModule: "dashboard", icon: "dashboard", keywords: ["home", "health", "attention"], allowedRoles: ALL_ROLES },
  { id: "alerts", legacyTab: "stream", path: "/alerts", label: "Live Alerts", pageTitle: "Live Alerts", group: "operations", routeModule: "alerts", icon: "alerts", keywords: ["ingestion", "stream", "events"], allowedRoles: ALL_ROLES, related: ["incidents"], showInNavigation: false },
  { id: "incidents", legacyTab: "summary", path: "/incidents", label: "Operations Workspace", pageTitle: "Operations Workspace", group: "operations", routeModule: "incidents", icon: "incidents", keywords: ["case", "investigation", "metadata"], allowedRoles: INCIDENT_ROLES, related: ["alerts", "approvals"] },
  ...
  { id: "copilot", legacyTab: "copilot", path: "/copilot", label: "Copilot", pageTitle: "Copilot", group: "intelligence", routeModule: "copilot", icon: "copilot", keywords: ["assistant", "analysis", "ai"], allowedRoles: INCIDENT_ROLES, showInNavigation: false },
  ...
  { id: "applications", legacyTab: "admin", path: "/applications", label: "Applications", pageTitle: "Applications", group: "platform", routeModule: "applications", icon: "applications", keywords: ["projects", "services", "onboarding"], allowedRoles: ENGINEERING_ROLES, showInNavigation: false },
  { id: "integrations", legacyTab: "admin", path: "/integrations", label: "Integrations", pageTitle: "Integrations", group: "platform", routeModule: "integrations", icon: "integrations", keywords: ["connectors", "monitoring", "providers"], allowedRoles: ENGINEERING_ROLES, showInNavigation: false },
  { id: "admin", legacyTab: "admin", path: "/admin", label: "Platform Settings", pageTitle: "Platform Settings", group: "platform", routeModule: "admin", icon: "admin", keywords: ["users", "roles", "configuration"], allowedRoles: ["administrator"] },
