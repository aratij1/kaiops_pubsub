...
export const NAVIGATION_ITEMS: readonly NavigationItem[] = [
  ...
  { id: "admin", legacyTab: "admin", path: "/admin", label: "Users & Access", pageTitle: "Users & Access", description: "Manage identities, roles, and access.", group: "platform", routeModule: "admin", icon: "admin", keywords: ["users", "roles", "access"], allowedRoles: ADMIN_ROLES },
  { id: "settings", legacyTab: "admin", path: "/admin/settings", label: "Settings", pageTitle: "Platform Settings", description: "Manage platform policy and configuration.", group: "platform", routeModule: "settings", icon: "settings", keywords: ["settings", "policy", "configuration"], allowedRoles: ADMIN_ROLES },
  ...
  { id: "audit", legacyTab: "audit", path: "/audit", label: "Audit", pageTitle: "Audit Trail", description: "Tenant-scoped immutable audit events.", group: "platform", routeModule: "audit", icon: "audit", keywords: ["history", "audit", "compliance"], allowedRoles: ADMIN_ROLES },
