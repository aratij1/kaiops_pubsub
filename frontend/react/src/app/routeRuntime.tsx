...
export interface AlertsRouteRuntime { loading: boolean; error: string; paused: boolean; liveState: string; lastEventAt: string; rows: AlertStreamRow[]; totalRows: number; updatedAt: string; section: string; view: string; savedViews: { id: string; label: string }[]; filters: AlertStreamFilters; filterOptions: { applications: string[]; environments: string[] }; density: string; counts: Record<string, number>; channel: string; query: string; refresh: () => void; open: (row: AlertStreamRow, stage?: string) => void; togglePaused: () => void; setSection: (value: string) => void; setView: (value: string) => void; applyView: (value: string) => void; updateFilter: (name: keyof AlertStreamFilters, value: string) => void; setDensity: (value: string) => void; setChannel: (value: string) => void; setQuery: (value: string) => void; }
