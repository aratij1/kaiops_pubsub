...
const steps = [
  ...
  { id: "approvals", path: "/approvals", number: "03", label: "Approvals", description: "Review guarded actions" },
] as const;

export const OperationsWorkflowNav = memo(function OperationsWorkflowNav({ active }: { active: typeof steps[number]["id"] }) {
