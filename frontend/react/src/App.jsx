    ...
    try {
      ...
      setSelectedAlertRegeneration({
        ...
        message: persistedAnalysis.ready
          ? requestedMode === "fresh"
            ? `Fresh context and RCA analysis completed for alert ${alertId}.${catalogProgress}`
            : requestedMode === "cache"
              ? `Verified cached context and RCA loaded for alert ${alertId}.${catalogProgress}`
              : `Smart analysis completed for alert ${alertId}; verified context was reused when eligible.${catalogProgress}`
