...
export default function IntegrationsRoute() {
  ...
  const submit = (event: FormEvent) => { event.preventDefault(); mutation.mutate({ ...form, labels: parseLabels(labelsText) }); };
  ...
  const cancel = () => { setEditing(null); setForm(initialForm); setLabelsText(labelsToText(initialForm.labels)); mutation.reset(); };
