...
class Settings(BaseSettings):
    ...
    vertex_model_armor_multi_language_detection: bool = Field(default=False, alias="VERTEX_MODEL_ARMOR_MULTI_LANGUAGE_DETECTION")
    vertex_model_armor_source_language: str = Field(default="", alias="VERTEX_MODEL_ARMOR_SOURCE_LANGUAGE")
    vertex_model_armor_sanitize_responses: bool = Field(default=False, alias="VERTEX_MODEL_ARMOR_SANITIZE_RESPONSES")
    vertex_ai_embeddings_enabled: bool = Field(default=False, alias="VERTEX_AI_EMBEDDINGS_ENABLED")
    vertex_ai_embeddings_model: str = Field(default="text-embedding-005", alias="VERTEX_AI_EMBEDDINGS_MODEL")
    vertex_ai_embeddings_task_type: str = Field(default="RETRIEVAL_DOCUMENT", alias="VERTEX_AI_EMBEDDINGS_TASK_TYPE")
    vertex_ai_embeddings_output_dimensionality: int = Field(default=0, alias="VERTEX_AI_EMBEDDINGS_OUTPUT_DIMENSIONALITY")
    vertex_ai_embeddings_timeout_seconds: float = Field(default=8.0, alias="VERTEX_AI_EMBEDDINGS_TIMEOUT_SECONDS")
    observability_gcp_trace_enabled: bool = Field(default=False, alias="OBSERVABILITY_GCP_TRACE_ENABLED")
    vertex_evaluation_enabled: bool = Field(default=False, alias="VERTEX_EVALUATION_ENABLED")
    vertex_evaluation_metric: str = Field(default="coherence", alias="VERTEX_EVALUATION_METRIC")
    vertex_evaluation_timeout_seconds: float = Field(default=8.0, alias="VERTEX_EVALUATION_TIMEOUT_SECONDS")
