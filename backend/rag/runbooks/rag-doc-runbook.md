kind: runbook
title: RAG-DOC response runbook
services: unknown
...
# RAG-DOC RAG_doc response runbook

Runbook checklist for responding to RAG-DOC.

## Triage
1. Confirm severity HIGH and affected service unknown.
