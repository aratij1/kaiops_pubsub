kind: runbook
title: DW-1011 response runbook
...
# DW-1011 Late Arriving Data response runbook

Runbook checklist for responding to DW-1011.

## Triage
1. Confirm severity HIGH and affected service transaction-feed.
