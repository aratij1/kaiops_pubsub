kind: runbook
title: DW-1002 response runbook
...
# DW-1002 Data Load Delay response runbook

Runbook checklist for responding to DW-1002.

## Triage
1. Confirm severity HIGH and affected service data-ingestion.
