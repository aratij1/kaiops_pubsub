kind: runbook
title: DW-1013 response runbook
services: sales-fact
...
# DW-1013 Fact Table Record Count Mismatch response runbook

Runbook checklist for responding to DW-1013.

## Triage
1. Confirm severity CRITICAL and affected service sales-fact.
