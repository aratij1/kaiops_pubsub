...
title: DW-1009 response runbook
...
# DW-1009 Replication Lag Exceeded Threshold response runbook



Runbook checklist for responding to DW-1009.



## Triage

1. Confirm severity HIGH and affected service replication-service.
